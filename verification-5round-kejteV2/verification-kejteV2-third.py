...
state[11][5]=k(5)+k(61)+k(77)
state[21][0]=k(0)+k(56)+k(72)
state[21][3]=k(3)+k(59)+k(75)

for i in range(2):
        state[17][1]=k(9+i)+k(65+i)+k(81+i)+v(1+i)


for i in range(2):
        state[17][5+i]=k(13+i)+k(69+i)+k(85+i)+v(5)
for i in range(2):
        state[14][0+i]=k(24+i)+k(40+i)+v(8+i)
for i in range(3);
        state[14][5+i]=k(28+i)+k(44+i)+v(12+i)
